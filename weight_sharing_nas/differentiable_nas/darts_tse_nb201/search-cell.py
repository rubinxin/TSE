# Example run of DARTS with TSE gradients on CIFAR10
# python ./search-cell.py --algo=darts_higher --data_path=$TORCH_HOME/cifar.python --higher_algo=darts_higher --rand_seed=1 --search_epochs=50 --inner_steps=100
